        ...
        <div class="container-fluid">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    ...
                    <el-button plain type="success" icon="el-icon-circle-plus"  @click="abrirModal('empleado', 'registrar')">Registrar</el-button>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-sm table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="d-none" v-text="empleado.sueldo"></td>
                    ...
                    <div class="modal-body">
                        ...
                        >
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="Nombre del empleado" size="mini" v-model="nombre"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-6">
                                    <el-select v-model="tipo_documento" size="mini" placeholder="Select">
                                        <el-option
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="Numero de documento" size="mini" v-model="num_documento"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="Telefono" size="mini" v-model="telefono"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="Email@gmail.com" size="mini" v-model="email"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="sueldo" size="mini" v-model.number="sueldo"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-select v-model="idrol" size="mini" placeholder="Selecciona el rol">
                                        <el-option
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="usuario" size="mini" v-model="usuario"></el-input>
                            ...
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input type="password" placeholder="password" size="mini" v-model="password"></el-input>
