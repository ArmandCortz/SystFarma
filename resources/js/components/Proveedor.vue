        ...
        <div class="container-fluid">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    ...
                    <el-button plain type="success" icon="el-icon-circle-plus"  @click="abrirModal('proveedor', 'registrar')">Nuevo</el-button>
                    ...
                    <div class="modal-body">
                        ...
                        >
                            <div class="form-group row">
                                ...
                                >
                                <div class="col-md-9">
                                    <el-input placeholder="Nombre del proveedor" v-model="nombre"></el-input>
